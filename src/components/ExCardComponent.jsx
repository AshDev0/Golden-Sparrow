...
export default function ExcavatorsCardComponent() {
  ...
  const columns = [
    {
      ...
      description: "Dig foundations, clear sites, and handle material with total control.",
      image: "/images/excavator_1.webp",
    },
    {
      title: "Demolition & Earthmoving",
      description: "Tear down, lift out, and move massive loads—no problem.",
      image: "/images/excavator_2.webp",
    },
    {
      title: "Utility & Pipework",
      description: "Carve clean, accurate trenches for pipelines and cables, even in tight spaces.",
      image: "/images/excavator_3.webp",
    },
    {
      title: "Rental Yards & Heavy Fleets",
      description: "Built for daily use, fast turnaround, and long service life.",
      image: "/images/excavator_4.webp",
    },
  ];
