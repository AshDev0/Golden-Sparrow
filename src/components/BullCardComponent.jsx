...
export default function BullCardComponent() {
  ...
  const columns = [
    {
      title: "Construction & Site Clearing",
      description: "Remove debris, level land, and prepare tough sites for development with superior pushing power.",
      image: "/images/bullDozer_1.webp",
    },
    {
      title: "Mining & Quarry Operations",
      description: "Handle overburden, clearing, and ground prep with high-torque bulldozers made for extreme loads.",
      image: "/images/bullDozer_2.webp",
    },
    {
      title: "Landscaping & Agriculture",
      description: "Precision grading, leveling, and soil reshaping for farms, plots, and large private lands.",
      image: "/images/bullDozer_3.webp",
    },
  ];
