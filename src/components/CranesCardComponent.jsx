...
export default function CranesCardComponent() {
  ...
  const columns = [
    {
      ...
      description: "Set beams, lift materials, and support major builds with precision and height.",
      image: "/images/crane_1.webp",
    },
    {
      title: "Industrial & Plant Maintenance",
      description: "Tackle complex lifts in factories, refineries, and confined industrial zones.",
      image: "/images/crane_2.webp",
    },
    {
      title: "Remote & Rough Terrain Jobs",
      description: "Reach remote locations with powerful off-road mobility and stable setups.",
      image: "/images/crane_3.webp",
    },
    {
      title: "Utility & Civil Works",
      description: "Assist with poles, bridges, or large-scale equipment installations with ease.",
      image: "/images/crane_4.webp",
    },
  ];
