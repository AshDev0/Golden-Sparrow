...
const WheelLoaderBrandSection = () => {
  ...
  return (
    <>
      <section className="wheel-loader-brands-section">
        <div className="container">
          {/* Header */}
          <header className="section-header">
            <h2 className="section-title">
              Your <span className="font-bold">Trusted</span> Wheel Loader Brands
            </h2>
          ...
          <div className="brands-content">
            ...
            <div className="block sm:hidden brand-label exclusive-label">
                <span className="font-medium">Exclusive</span> Wheel Loader Brands
              </div>
...
export default WheelLoaderBrandSection;