...
const SkidBrandSection = () => {
  // Sample brand logos data
  const brandLogos = [
    { id: 1, src: './images/heli_1.png', alt: 'Heli', name: 'Heli' },
    { id: 2, src: './images/un_forklift_1.png', alt: 'Caterpillar', name: 'Caterpillar' },
    { id: 3, src: './images/socma.png', alt: 'Socma', name: 'Socma' },
    { id: 4, src: './images/toyota_1.png', alt: 'Toyota', name: 'Toyota' },
    { id: 5, src: './images/komatsu_1.png', alt: 'Komatsu', name: 'Komatsu' },
    { id: 6, src: './images/cat.png', alt: 'Caterpillar', name: 'Caterpillar' },
  ];

  const primaryLogo = {
    src: './images/rippa_1.png',
    alt: 'Rippa',
    name: 'Rippa'
  };
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center lg:text-left mb-8 lg:mb-6">
          <h2 className="text-2xl sm:text-3xl lg:text-4xl xl:text-5xl font-normal mb-4">
            You <span className="font-bold">Trusted</span> Skid Steer Brands
          </h2>
        ...
        <div className="flex flex-col lg:flex-row gap-4 sm:gap-8 items-center lg:items-stretch overflow-hidden">
          ...
          <div className="w-full lg:w-[300px] flex-shrink-0 flex justify-center lg:border-r-2 lg:border-gray-200 lg:pr-6">
            ...
            <span className="font-medium">Exclusive</span> Skid Steer Brands
          </p>
              <div className="absolute w-[72%] h-[65%] left-[14%] top-[18%] z-10 mt-3 sm:mt-3"
              style={{
                        border: "1px solid",
                        borderImageSource:
        ...
        <div className="flex flex-col sm:flex-row justify-between items-center mt-6 lg:mt-8 space-y-4 sm:space-y-0">
          <div className="flex items-end gap-2">
            ...
            <div className="hidden lg:block w-14 h-px mb-1 bg-black"></div>
          </div>
          <div className="flex items-end gap-2">
...
export default SkidBrandSection;