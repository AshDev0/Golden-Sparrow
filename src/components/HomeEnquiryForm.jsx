...
const EnquiryForm = ({
  title,
  content,
  backgroundImages = [], // Accept array of images, with fallback to empty array
  backgroundImage, // Keep backward compatibility
}) => {
  ...
  // Prepare images array for slider (use backgroundImages if provided, otherwise fallback to single backgroundImage)
  const imagesToShow = backgroundImages.length > 0 ? backgroundImages : (backgroundImage ? [backgroundImage] : []);
