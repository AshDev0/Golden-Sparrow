  ...
  const columns = [
    {
      ...
      description: "Move gravel, sand, and debris with speed and precision across job sites.",
      image: "/images/wheelLoader_1.webp",
    },
    {
      title: "Heavy Material Handling",
      description: "Lift and transport bulk loads with powerful hydraulics and steady control.",
      image: "/images/wheelLoader_2.jpg",
    },
    {
      title: "Roadwork & Utilities",
      description: "Support infrastructure jobs with reliable pushing, loading, and backfilling.",
      image: "/images/wheelLoader_3.jpg",
    },
    {
      title: "Quarries & Industrial Yards",
      description: "Engineered to endure tough terrain and maximize cycle times.",
      image: "/images/wheelLoader_4.jpg",
    },
  ];
