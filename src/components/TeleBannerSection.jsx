...
export default function TeleHandlersCardComponent() {
  ...
  const columns = [
    {
      ...
      description: "Lift heavy materials, move pallets, and access hard-to-reach areas safely.",
      image: "/images/tele_1.webp",
    },
    {
      title: "Industrial Yards & Warehouses", 
      description: "Handle bulk loads, containers, and equipment with long reach and high stability.",
      image: "/images/tele_2.webp",
    },
    {
      title: "Rough Terrain Projects",
      description: "Reliable off-road mobility and lifting power for uneven job sites",
      image: "/images/tele_3.webp",
    },
    {
      title: "Rental Fleets & Equipment Yards",
      description: "Durable machines built for repeat use and high demand environments.",
      image: "/images/tele_4.webp",
    }
  ];
