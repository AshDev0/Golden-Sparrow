...
import BackBannerSection from "../components/BackBannerSection";
import BackBrandSection from '../components/BackBrandSection';
...
{/* Hero Section For Backhoe Page */}
      <section
                  ...
                  >
                      ...
                      <div className="max-w-none sm:max-w-2xl md:max-w-3xl lg:max-w-4xl">
                        <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-normal text-white mb-4 sm:mb-6 leading-tight">
                          <span className="font-semibold">
                            Dig. Load. Power Through.
                            <br className="hidden sm:block" />
                          </span>
                          {' '}Reliable Backhoe Loaders for
                        ...
                        <p className="text-sm sm:text-base md:text-lg lg:text-xl text-white font-semibold mb-6 sm:mb-8 leading-relaxed max-w-none sm:max-w-lg md:max-w-2xl lg:max-w-3xl">
                          Golden Sparrow connects you with backhoe loaders built to dig, load, lift, and move — all with unmatched efficiency and control.
                        </p>
                    ...
                    <style jsx>{`
                      .hero-section {
                        background-image: url('./images/back_bnr.jpg');
      ...
      <section className="pb-16 bg-white">
        ...
        <h2 className="text-2xl sm:text-3xl lg:text-4xl xl:text-5xl font-normal text-gray-900 mb-2"><span className="font-bold">Backhoe Loader Excellence</span></h2>
        <h3 className="text-2xl sm:text-3xl lg:text-4xl xl:text-5xl font-normal text-gray-900 mb-6">Built to Adapt. Ready to Deliver.</h3>
        <p className="text-black text-base sm:text-lg lg:text-xl font-semibold max-w-6xl">Whether you're working in narrow city streets or open job sites, Backhoe loaders are engineered for performance and agility, combining power, precision, and multi-functionality in a single, compact machine.</p>
      </div>
          <BackBannerSection />
        </div>
      </section>
 ...
 {/* Banner Section */}
      <section className="back-bnrx py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex justify-end">
          <div className="max-w-max">
          <h2 className="text-2xl md:text-5xl lg:text-5xl font-normal text-white leading-normal mb-6">
            <span className="font-semibold">Backhoe Loaders</span><br/>Dig. Load. Dominate.
          </h2>
          <p className="text-lg md:text-xl text-white leading-relaxed mb-8"><span className="font-semibold">Built to Handle the Rough Stuff</span><br/>We supply high-performance backhoe loaders ready for<br/>digging, trenching, and material handling</p>
...
<ul className="flex flex-col gap-2 mb-6">
        <li className="text-white">
          <p className="flex items-center gap-2 mb-1">
            ...
            <span className="font-semibold">Dual-End Versatility</span>
          </p>
 
          <p className="pl-8">Switch seamlessly between loader and excavator functions.</p>
        ...
        <li className="text-white">
          <p className="flex items-center gap-2 mb-1">
            ...
            <span className="font-semibold">Rugged & Reliable</span>
          </p>
          <p className="pl-8">Tackles rough sites with ease and endurance.</p>
        </li>
</ul>
 
<span className="font-semibold text-white mb-4">Always up for the task. Let’s get to work.</span>
...
.back-bnrx {
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <EnquiryForm title={<>Need the<br className="hidden sm:block"/><span className="font-semibold">{" "}Backhoe Loader?</span></>} content={<><p className="text-lg lg:text-xl mb-8 text-white leading-relaxed">
