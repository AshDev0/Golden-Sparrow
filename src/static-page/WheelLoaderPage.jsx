...
import WlBrandSection from '../components/WlBrandSection';
import WlCardComponent from "../components/WlCardComponent";
import { Phone } from "lucide-react";
const WheelLoaderPage = () => {
  ...
  return (
    ...
    {/* Hero Section For Wheel Loader */}
      ...
      >
        ...
        <style jsx>{`
          .hero-section {
            background-image: url('./images/wheelLoaderBanner.webp');
      ...
      <section className="pb-16 bg-white">
              ...
              <h2 className="text-2xl sm:text-3xl lg:text-4xl xl:text-5xl font-normal text-gray-900 mb-2"><span className="font-bold">Wheel Loader Performance</span><br/>Built for Power. Ready for Any Load.
      </h2>
              <p className="text-black text-base sm:text-lg lg:text-xl font-semibold max-w-6xl">From rugged construction zones to industrial yards, Wheel Loaders deliver unmatched strength, speed, and versatility for material handling and earthmoving tasks.</p>
            </div>
      ...
      <section className="forklift-bnrx py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex justify-end">
          ...
          <h2 className="text-2xl md:text-5xl lg:text-5xl font-normal text-white leading-normal mb-6">
            <span className="font-bold">Wheel Loader</span><br/>Scoop. Carry. Conquer.
          </h2>
          <p className="text-lg md:text-xl text-white font-semibold leading-relaxed mb-8">Built for Maximum Load Efficiency. <span className="font-normal">Robust & ready for<br/>material handling, site cleanup, and earthmoving.</span></p>
...
<ul className="flex flex-col gap-2 mb-6">
        <li className="text-white">
          <p className="flex items-center gap-2 mb-1">
            ...
            <span className="font-semibold">High Breakout Force</span>
          </p>
          <p className="pl-8">Lift and load heavy materials quickly with powerful hydraulic arms.</p>
         </li>
        ...
        <li className="text-white">
          <p className="flex items-center gap-2 mb-1">
            ...
            <span className="font-semibold">All-Terrain Stability</span>
          </p>
          <p className="pl-8">Stay balanced and in control on uneven or slippery surfaces.</p>
        </li>
        <li className="text-white">
          <p className="flex items-center gap-2 mb-1">
            <span className="bg-[#FFC501] rounded-full w-6 h-6 flex items-center justify-center flex-shrink-0">
            ...
            <span className="font-semibold">Ergonomic Operation</span>
          </p>
          <p className="pl-8">Intuitive controls and a comfortable cabin keep operators productive all day.</p>
        </li>
</ul>
 
<span className="font-semibold text-white mb-4">Always moving forward. Let’s get to work.</span>
...
<div className="flex flex-col sm:flex-row gap-4 mt-4">
  ...
  rgba(0, 0, 0, 0) 58.49%),
        url('./images/wheelLoader_banner_2.webp');
    background-size: cover;
...
.forklift-bnrx {
    ...
    {/* Enquiry Form  Section    */}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <EnquiryForm title={<>Need the<br className="hidden sm:block"/><span className="font-semibold">{" "}Wheel Loader?</span></>} content={<><p className="text-lg lg:text-xl mb-8 text-white leading-relaxed">
          ...
          backgroundImage="./images/wheelLoaderForm.jpg" />
      </div>
      </div>
...
export default WheelLoaderPage;
