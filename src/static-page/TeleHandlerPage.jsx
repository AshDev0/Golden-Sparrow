...
import TeleBannerSection from "../components/TeleBannerSection";
import TeleBrandSection from '../components/TeleBrandSection';
import { Phone } from "lucide-react";
const TeleHandlerPage = () => {
  ...
  return (
    <div>
      {/* Hero Section For Telehandler Page */}
<section
                  ...
                  >
                    ...
                    <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 xl:px-10 py-16 sm:py-20 md:py-24 lg:py-28 xl:py-32 h-full flex items-center">
                      <div className="max-w-none sm:max-w-2xl md:max-w-3xl lg:max-w-4xl">
                        ...
                        <p className="text-sm sm:text-base md:text-lg lg:text-xl text-white font-semibold mb-6 sm:mb-8 leading-relaxed max-w-none sm:max-w-lg md:max-w-2xl lg:max-w-3xl">
                          Golden Sparrow's telehandlers are built for heavy lifting, long reach, and tough terrain.
                        </p>
                    ...
                    <style jsx>{`
                      .hero-section {
                        background-image: url('./images/tele_banner.webp');
      ...
      <section className="pb-16 bg-white">
        ...
        <h2 className="text-2xl sm:text-3xl lg:text-4xl xl:text-5xl font-normal text-gray-900 mb-2">Elite & Reliable <span className="font-bold">Telehandler</span> Solutions</h2>
        <h3 className="text-2xl sm:text-3xl lg:text-4xl xl:text-5xl font-normal text-gray-900 mb-6">For Tough Lifting & Material Handling Tasks</h3>
        <p className="text-black text-base sm:text-lg lg:text-xl font-semibold max-w-6xl">No matter the site, Golden Sparrow delivers rugged SOCOMA Telehandlers<br/>designed to lift, extend, and perform — wherever you need them most:</p>
      </div>
          <TeleBannerSection />
        </div>
      </section>
 ...
 {/* Banner Section */}
      <section className="tele-bnrx py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex justify-end">
          <div className="max-w-max">
          <h2 className="text-2xl md:text-5xl lg:text-5xl font-normal text-white leading-normal mb-6">
            Lift More. Reach Higher.<br/>with toughest <span className="font-bold">Telehandlers</span>
          </h2>
          <p className="text-lg md:text-xl text-white font-semibold leading-relaxed mb-8">Heavy Lifting, Handled - Socma Telehandlers deliver<br/>powerful lifting, extended reach, and stable handling.</p>
...
<ul className="flex flex-col gap-2 mb-6">
        <li className="text-white">
          <p className="flex items-center gap-2 mb-1">
            ...
            <span className="font-semibold">Extended Reach & Lift Capacity</span>
          </p>
 
          <p className="pl-8">Move heavy loads vertically and horizontally with ease.</p>
        ...
        <li className="text-white">
          <p className="flex items-center gap-2 mb-1">
            ...
            <span className="font-semibold">All-Terrain Performance</span>
          </p>
          <p className="pl-8">Built for stability and traction on rough, uneven ground.</p>
        </li>
        <li className="text-white">
          <p className="flex items-center gap-2 mb-1">
            <span className="bg-[#FFC501] rounded-full w-6 h-6 flex items-center justify-center flex-shrink-0">
            ...
            <span className="font-semibold">Safe & Versatile Handling</span>
          </p>
          <p className="pl-8">Designed for operator safety and flexibility across tasks.</p>
        </li>
</ul>
 
<span className="font-semibold text-white mb-4">Reliable. Powerful. Ready for every job.</span>
...
.tele-bnrx {
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <EnquiryForm title={<>Need the <span className="font-semibold">Right Telehandler?</span></>} content={<><p className="text-lg lg:text-xl mb-8 text-white leading-relaxed">
          ...
          backgroundImage="./images/tele_enq_bnr.png" />
      </div>
      </div>
...
export default TeleHandlerPage;